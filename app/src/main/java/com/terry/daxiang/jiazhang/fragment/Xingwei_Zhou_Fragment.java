...
public class Xingwei_Zhou_Fragment extends BaseFragment implements BaseQuickAdapter.OnRecyclerViewItemClickListener{
    ...
    private void loadNetData(){
        RequestService.doGet(Urls.getChildWeekActionReport(SharedPrefUtils.getString(getActivity(),SharedPrefUtils.APP_USER_ID)), RESULT_ALL_DATA , this);
    }
