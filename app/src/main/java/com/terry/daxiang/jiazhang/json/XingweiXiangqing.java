...
public class XingweiXiangqing {
    ...
    private List<XingweiXiangqingBean> data;

    public List<XingweiXiangqingBean> getData() {
        return data;
    }

    public void setData(List<XingweiXiangqingBean> data) {
        this.data = data;
    }

    public static class XingweiXiangqingBean {
        private String name;
        private String text;
