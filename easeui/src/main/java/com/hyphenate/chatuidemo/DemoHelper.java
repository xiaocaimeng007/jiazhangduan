    	...
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReceived(List<EMMessage> messages) {
			    for (EMMessage message : messages) {
                    ...
                    //************接收并处理扩展消息***********************
                    String userName = message.getStringAttribute(SharedPrefUtils.APP_USER_NICKNAME, "");
                    String userPic = message.getStringAttribute(SharedPrefUtils.APP_USER_AVATAR, "");
