	...
	private void initListener() {
		...
		if(username != null){
    		if (username.equals(EMClient.getInstance().getCurrentUser())) {
    			tvUsername.setText(SharedPrefUtils.getString(this,SharedPrefUtils.APP_USER_NICKNAME));
//    			EaseUserUtils.setUserNick(username, tvNickName);
    			EaseUserUtils.setUserNick(SharedPrefUtils.getString(this,SharedPrefUtils.APP_USER_NICKNAME)
						, tvNickName);
