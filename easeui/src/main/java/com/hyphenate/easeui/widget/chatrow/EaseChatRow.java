...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            ...
            String currentUserNick = DemoApplication.getInstance().getCurrentUserNick();
            if(usernickView != null&&!TextUtils.isEmpty(currentUserNick)){
                usernickView.setText(currentUserNick);
